...
function RenderListItem({
    ...
    return (
        <TouchableOpacity activeOpacity={0.8} style={_listItemContainerStyle} onPress={__onPress} onLayout={onLayout} {...props} disabled={selectable === false || disabled} testID={item.testID}>
            {IconComponent}
