...
function Picker({
    ...
    const _CloseIconComponent = useMemo(() => {
        ...
        return (
            <TouchableOpacity activeOpacity={0.8} style={_closeIconContainerStyle} onPress={onPressClose}>
                {Component}
            </TouchableOpacity>
        );
    ...
    return (
        <>
            <View style={_containerStyle} {...containerProps}>
                <TouchableOpacity activeOpacity={0.8} style={_style} onPress={__onPress} onLayout={__onLayout} {...props} ref={onRef} pointerEvents={pointerEvents} disabled={disabled} testID={testID}>
                    {_BodyComponent}
                    {_ArrowComponent}
                </TouchableOpacity>
