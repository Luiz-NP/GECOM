...
declare type InputOutline = InputOutlineMethods;
declare const InputOutline: React.ForwardRefExoticComponent<InputOutlineProps & React.RefAttributes<InputOutlineMethods>>;
export { InputOutline };
